...
highlight /^.*\.(jpg|jpeg|png|gif|tiff|webp|bmp|svg|svgz)$/ ctermfg=blue
highlight /^.*\.(zip|gz|bz2|xz|tar|tgz|tbz2|7z|rar|iso|rpm|deb)$/ ctermfg=green
highlight /^.*\.(vim)$/ ctermfg=cyan
highlight /^.*\.(conf)$/ ctermfg=red
highlight /^.*\.(sh)$/ ctermfg=magenta
