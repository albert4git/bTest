...
""==================================================================================
" guifg='#0e4411'  guibg='#FF0000'
" guifg='#0df6e3'  guibg='#cc04a2'
" guifg='#fd56e3'  guibg='#00ff00'
" guifg='#fdff63'  guibg='#FF0000'
""==================================================================================
...
let s:gb.xGelb1      = ['#ffff00', 11]
let s:gb.xBraun1     = ['#580004', 52]
let s:gb.xBraun2     = ['#881144', 52]
let s:gb.xCyan1      = ['#00ffff', 14]
let s:gb.xGruen0     = ['#054211', 16]
let s:gb.xGruen1     = ['#005f00', 16]
let s:gb.xGruen2     = ['#008080', 6]
...
let s:gb.xBlau2      = ['#0000ff', 12]
let s:gb.xBlau3      = ['#005fff', 27]
let s:gb.xBlau4      = ['#00dfff', 45]
let s:gb.xMagenta1   = ['#ff00ff', 13]
let s:gb.xBrom1      = ['#820384', 5]
let s:gb.xGrau1      = ['#eeeeee', 7]
let s:gb.xGrau2      = ['#e2e2e2', 7]
let s:gb.xGrau3      = ['#c5c5c5', 7]
let s:gb.xGrau4      = ['#aaaaaa', 7]
let s:gb.xGrau5      = ['#808080', 8]

"Start
"-=HLComment
"Pueblo-Pablo-Def
"Palete-Pallete-PALETE: fill it with absolute colors
...
let s:gb.neutral_red    = ['#0004fd', 124]     " 204-36-29
...
call s:HL('GruvboxAqua', s:gb.xGruen5)
...
"---------------------------------------------------------------------------------
call s:HL('Comment', s:gb.xGrau3, s:gb.xGruen0, s:italicize_comments)
call s:HL('Todo', s:vim_fg, s:vim_bg, s:bold . s:italic)
call s:HL('Error', s:red, s:vim_bg, s:bold . s:inverse)
"---------------------------------------------------------------------------------
" Line used for closed folds
call s:HL('Folded', s:gray, s:bg1, s:italic)
call s:HL('Folded', s:gray, s:gb.xBraun1, s:italic)
" Column where folds are displayed
call s:HL('FoldColumn', s:gray, s:gb.xRot2)
"---------------------------------------------------------------------------------
