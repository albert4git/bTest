...
def switch_backend(newbackend):
    ...
    backend_name = (newbackend[9:] if newbackend.startswith("module://") else
                    "matplotlib.backends.backend_{}".format(
                        newbackend.lower()))

    backend_mod = importlib.import_module(backend_name)
    Backend = type("Backend", (matplotlib.backends._Backend, ),
                   vars(backend_mod))
...
def rgrids(*args, **kwargs):
    ...
    **kwargs
    ...
    return (silent_list('Line2D rgridline',
                        lines), silent_list('Text rgridlabel', labels))
...
def thetagrids(*args, **kwargs):
    ...
    **kwargs
    ...
    return (silent_list('Line2D thetagridline',
                        lines), silent_list('Text thetagridlabel', labels))
...
def get_plot_commands():
    ...
    exclude = {
        'colormaps', 'colors', 'connect', 'disconnect', 'get_plot_commands',
        'get_current_fig_manager', 'ginput', 'plotting', 'waitforbuttonpress'
    }
    ...
    return sorted(
        ...
        and inspect.isfunction(obj) and inspect.getmodule(obj) is this_module)
...
def barbs(*args, data=None, **kw):
    return gca().barbs(*args, **({
        "data": data
    } if data is not None else {}), **kw)
...
def broken_barh(xranges, yrange, *, data=None, **kwargs):
    return gca().broken_barh(xranges, yrange,
                             **({
                                 "data": data
                             } if data is not None else {}), **kwargs)
...
def eventplot(positions,
              ...
              *,
              data=None,
              **kwargs):
    return gca().eventplot(positions,
...
def magnitude_spectrum(x,
                       ...
                       *,
                       data=None,
                       **kwargs):
    return gca().magnitude_spectrum(x,
                                    Fs=Fs,
                                    Fc=Fc,
                                    window=window,
                                    pad_to=pad_to,
...
def table(cellText=None,
          ...
          edges='closed',
          **kwargs):
    return gca().table(cellText=cellText,
...
def text(x,
         ...
         s,
         fontdict=None,
         withdash=cbook.deprecation._deprecated_parameter,
         **kwargs):
...
def ticklabel_format(*,
                     ...
                     useLocale=None,
                     useMathText=None):
    return gca().ticklabel_format(axis=axis,
                                  style=style,
                                  scilimits=scilimits,
                                  useOffset=useOffset,
                                  useLocale=useLocale,
