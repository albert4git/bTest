...
hi Normal                guifg=#0fefef   guibg=#1b1b13   gui=NONE
hi Title                 guifg=#0fffff   guibg=NONE      gui=NONE

hi Comment               guifg=#05715e   guibg=NONE      gui=NONE
hi Conceal               guifg=#05715e   guibg=NONE      gui=NONE
hi Constant              guifg=#09f6fa   guibg=NONE      gui=NONE
hi String                guifg=#0ff600   guibg=#333100   gui=NONE
hi Character             guifg=#0500ff   guibg=NONE      gui=NONE
hi Number                guifg=#0500ff   guibg=NONE      gui=NONE
hi Boolean               guifg=#0500ff   guibg=NONE      gui=NONE
hi Float                 guifg=#0500ff   guibg=NONE      gui=NONE
hi Identifier            guifg=#00d5dd   guibg=NONE      gui=NONE
hi Function              guifg=#00d5dd   guibg=NONE      gui=NONE

hi Statement             guifg=#0f027f   guibg=NONE      gui=NONE
hi Conditional           guifg=#060000   guibg=NONE      gui=NONE
hi Repeat                guifg=#060000   guibg=NONE      gui=NONE
hi Label                 guifg=#0f027f   guibg=NONE      gui=NONE
hi Operator              guifg=#0f027f   guibg=NONE      gui=NONE
hi Keyword               guifg=#0f027f   guibg=NONE      gui=NONE
hi Exception             guifg=#060000   guibg=NONE      gui=NONE

" hi PreProc               guifg=#0c5f00   guibg=NONE      gui=NONE
hi PreProc               guifg=#05715e   guibg=NONE   gui=NONE
hi Include               guifg=#05715e   guibg=NONE   gui=NONE
hi Define                guifg=#05715e   guibg=NONE   gui=NONE
hi Macro                 guifg=#05715e   guibg=NONE   gui=NONE
hi PreCondit             guifg=#05715e   guibg=NONE   gui=NONE

hi Type                  guifg=#0cff00   guibg=NONE      gui=NONE
hi StorageClass          guifg=#0f4b00   guibg=NONE      gui=NONE
hi Structure             guifg=#0cff00   guibg=NONE      gui=NONE
hi Typedef               guifg=#3cff00   guibg=NONE      gui=NONE

hi Special               guifg=#0f4b00   guibg=NONE      gui=NONE
hi SpecialChar           guifg=#0f4b00   guibg=#330f00   gui=NONE
hi Tag                   guifg=#06a6ff   guibg=#003e65   gui=NONE
hi Delimiter             guifg=#0f027f   guibg=NONE      gui=NONE
hi SpecialComment        guifg=#0f4b00   guibg=#330f00   gui=NONE
hi Debug                 guifg=#0f4b00   guibg=NONE      gui=NONE

hi Underlined            guifg=NONE      guibg=NONE      gui=Underline
hi Ignore                guifg=NONE      guibg=NONE      gui=NONE
hi Error                 guifg=#07d7d7   guibg=#e60000   gui=NONE
hi Todo                  guifg=#000000   guibg=#75715e   gui=NONE

" hi ColorColumn           guifg=#0f0000   guibg=#121212    gui=NONE
hi ColorColumn           guifg=#0f0000   guibg=NONE    gui=inverse
hi Noise                 guifg=#0200a8   guibg=NONE       gui=NONE

" Vim UI Stuff
hi Cursor                guifg=#000000   guibg=#ff027f   gui=NONE
hi NonText               guifg=#000000   guibg=NONE      gui=NONE
hi EndOfBuffer           guifg=#0b1b13
hi LineNr                guifg=#044444   guibg=NONE      gui=NONE
hi SignColumn            guifg=#044444   guibg=NONE      gui=NONE
hi Visual                guifg=#0b1b13   guibg=#efefef   gui=NONE
hi VisualNOS             guifg=#0fffff   guibg=#ff0000   gui=NONE
hi VertSplit             guifg=#044444   guibg=NONE      gui=NONE
hi Pmenu                 guifg=#099999   guibg=#121212   gui=NONE
hi PmenuSel              guifg=#000000   guibg=#72faff   gui=NONE
hi PmenuSbar             guifg=NONE      guibg=NONE      gui=NONE
hi PmenuThumb            guifg=#0f0000
hi SpecialKey            guifg=#444444   guibg=NONE      gui=NONE
hi StatusLine            guifg=NONE      guibg=#222222   gui=bold
hi StatusLineNC          guifg=#044444   guibg=#222222   gui=NONE
hi CursorLine            guifg=NONE      guibg=NONE      gui=NONE
hi CursorLineNr          guifg=#0f027f   guibg=NONE      gui=BOLD
hi CursorColumn          guifg=NONE      guibg=#000000   gui=NONE
hi MatchParen            guifg=#000000   guibg=#8200a8   gui=NONE
hi Search                guifg=#0C167C   guibg=#481a28   gui=NONE
hi QuickFixLine                guifg=#FC167C   guibg=#481a28   gui=NONE
hi IncSearch             guifg=#0C167C   guibg=#481a28   gui=INVERSE

hi Directory             guifg=#36a6ff   guibg=NONE      gui=NONE
hi Folded                guifg=#05715e   guibg=#121212   gui=NONE
hi FoldColumn            guifg=#05715e   guibg=#121212   gui=NONE

hi ErrorMsg              guifg=#060000   guibg=NONE      gui=NONE
hi WarningMsg            guifg=#0ff600   guibg=NONE      gui=NONE

" hi TabLine               guifg=#0f0000
hi TabLineFill           guifg=#121212   guibg=#000000   gui=NONE
hi TabLine               guifg=#05715e   guibg=#000000   gui=NONE
hi TabLineSel            guifg=#0fffff   guibg=#000000   gui=BOLD
