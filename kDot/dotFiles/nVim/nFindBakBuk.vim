...
:new|0read !java #:r
---------------------------------------------------------------------------
You can use -q to populate Vim's quickfix list with a list of errors:
vim -q errorfile.txt
---------------------------------------------------------------------------
You can use find's -printf command to format its output like a regular "UNIX" error list:
find . -name whatever.txt -printf "%p:1:1:%f\n"
---------------------------------------------------------------------------
You can use file redirection to pass the output of the command above to Vim as an error list:
vim -q <(find . -name whatever.txt -printf "%p:1:1:%f\n")
---------------------------------------------------------------------------
...
ctrl-a - select all
ctrl-d - deselect all
ctrl-x / ctrl-v|s / ctrl-t (current window / horizontal splits / vertical splits / tabs)
---------------------------------------------------------------------------
