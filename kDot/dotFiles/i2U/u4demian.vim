...
nnoremap ,b :lprevzvzz
nnoremap ,` viWa"gvoi"gvo3l
xnoremap ,' a'gvoi'gvoll
nmap ,v :e $MYVIMRC
xmap ,v :e $MYVIMRC
omap ,v :e $MYVIMRC
nmap ,s :source $MYVIMRC
xmap ,s :source $MYVIMRC
omap ,s :source $MYVIMRC
xnoremap . :normal .
...
xnoremap } }^
onoremap } }^
nnoremap <SNR>211_: :=v:count ? v:count : ''
...
map <C-=> =
map <M-F12> :call EditorvsNotepad()
map <S-F12> :call Switch_background()
map <S-F10> :execute "vimgrep /" . expand("<cword>") . "/j **" | cw
...
set tabpagemax=15
set tags=tags,./tags,../tags,../../tags,../../../tags,../../../../tags,../../../../../tags,~/Documents/scala/tags,~/Documents/*/tags
...
set shortmess=aoO
badd +13 vimrc-ink.vim
badd +144 vim-inkItchyMashine.vim
badd +428 ~/git/aTest/dotFiles/inkWim/demian-wimrc.vim
badd +34 vim-inkAutoGroupAutoCommand.vim
argglobal
silent! argdel *
$argadd vimrc-ink.vim
set lines=36 columns=146
edit ~/git/aTest/dotFiles/inkWim/demian-wimrc.vim
...
setlocal tabstop=8
setlocal tagcase=
setlocal tags=~/git/aTest/tags,tags,./tags,../tags,../../tags,../../../tags,../../../../tags,../../../../../tags,~/Documents/scala/tags,~/Documents/*/tags
setlocal termkey=
setlocal termsize=
...
let s:l = 468 - ((32 * winheight(0) + 16) / 33)
