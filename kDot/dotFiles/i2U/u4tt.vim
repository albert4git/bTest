...
nnoremap <C-;> :silent! call JumpToTag()
...
set shortmess=aoO
badd +4 vim-inkItchyMashine.vim
badd +128 vimrc-ink.vim
badd +11 vim-inkTTemp.vim
badd +225 vim-inkTemp.vim
badd +4 vim-inkAutoGroupAutoCommand.vim
argglobal
silent! argdel *
$argadd vim-inkItchyMashine.vim
set lines=40 columns=146
edit vim-inkAutoGroupAutoCommand.vim
...
setlocal tabstop=8
setlocal tagcase=
setlocal tags=~/git/aTest/tags,~/git/aTest/dotFiles/inkVim/tags
setlocal termkey=
setlocal termsize=
