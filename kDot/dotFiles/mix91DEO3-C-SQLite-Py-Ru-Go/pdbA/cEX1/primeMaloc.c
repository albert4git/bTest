 ...
 * =====================================================================================
 *
 *       Filename:  primeMaloc.c
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  17.03.2019 02:15:19
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
int main(void)
{
        ...
        //scanf_s("%d", &total);
        scanf("%d", &total);
        // Total is how many we need to find
        total = total < 4 ? 4 : total;
        // Make sure it is at least 4
