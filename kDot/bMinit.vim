...
" Last Modified:      Sa 18 Mai 2019 04:10:18  CEST
"===============================================================================================================
"===============================================================================================================
        set path+=.,/media/red/124Black/git/bTest/pyLabGitPdbPythonMode27
        set path+=., /media/red/124Black/git/bTest/kDot
        "------------------------------------------------------------------------------------
        set runtimepath+=~/vim-amake
        "------------------------------------------------------------------------------------
        let $MYVIMRC='/media/red/124Black/git/bTest/kDot/bMinit.vim'
        "------------------------------------------------------------------------------------
        let s:thesaurus_pat =  "/media/red/124Black/git/bTest/DICT/mthesaur.txt"
        let g:tq_mthesaur_file="/media/red/124Black/git/bTest/DICT/mthesaur.txt"
        set thesaurus=/media/red/124Black/git/bTest/DICT/mthesaur.txt
        set dictionary+=/media/red/124Black/git/bTest/DICT/english-words.txt
        "------------------------------------------------------------------------------------
        filetype on
        filetype plugin on
        filetype indent on
...
"-AAA4-undo-------------------------------------------------------------------------------------------------{{{
        ...
        "#/media/red/124Black/git/dotRedConfig
        set undodir  =/media/red/124Black/git/dotRedConfig/nvim/undoDir/      " undo files
        set backupdir=/media/red/124Black/git/dotRedConfig/nvim/backUpDir/  " backups
        set directory=/media/red/124Black/git/dotRedConfig/nvim/swapDir/    " swap files
        "----------------------------------------------------------------------------------
...
"-2Remap-}}}
        ...
        "source ~/git/bTest/kDot/b5DEO.vim
        source /media/red/124Black/git/bTest/kDot/b5DEO.vim
        hi pythonSelf  ctermfg=68 cterm=bold 
        "::::::CYAN::::::::::::::::-=2=-::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
        source /media/red/124Black/git/bTest/kDot/mix/n-badwolf.vim
