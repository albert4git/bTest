...
"------------------------------------------------
let g:hykeys =  [ 'u', '<c-u>', 'd', '<c-d>' ]
let g:hykeys += [ 'U', ':Unite<cr>' ]
let g:hykeys += [ 'p', ':CtrlP<cr>' ]
let g:hykeys += [ 'P', ':CtrlPMRU<cr>' ]
let g:hykeys += [ 'm', ':BookmarkToggle<cr>' ]
let g:hykeys += [ 'a', ':BookmarkShowAll<cr>' ]
let g:hykeys += [ 'r', '`[v`]' ]
let g:hykeys += [ 'b', 'ggVG' ]
let g:hykeys += [ 'g', ':Ack <cword> .<cr>' ]
"let g:hykeys += [ '','' ]
"let g:hykeys += [ '','' ]
"let g:hykeys += [ '','' ]
