...
set backupdir=~/tmp             " but don't clutterPWD with them
...
" .vimrc editing                                                {{{2
set wildcharm=<C-Z>
map             ,e              :eHOME/.vim/vimrc<CR>
map             ,s              :sourceHOME/.vim/vimrc<CR>
map             ,PE             :eHOME/.vim/plugin/<C-Z><C-Z>
map             ,IE             :eHOME/.vim/indent/<C-Z><C-Z>
map             ,FE             :eHOME/.vim/ftplugin/<C-Z><C-Z>
map             ,XE             :eHOME/.vim/syntax/<C-Z><C-Z>
